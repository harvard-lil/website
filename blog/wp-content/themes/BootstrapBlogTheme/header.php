...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<head>
		...
		<link rel="stylesheet" href="http://hlsl7.law.harvard.edu/dev/site/css/style.css">
		<?php
		...
		<link rel="stylesheet" href="http://hlsl7.law.harvard.edu/dev/jeff/site/css/style.css">
		<?php 
